...
describe('OnyxSidebarV2', () => {
  it('renders donor sidebar shell structure in SSR', () => {
    ...
    expect(markup).toContain('data-testid="onyx-native-donor-sidebar-section-card-Agents"')
    expect(markup).toContain('data-testid="onyx-native-donor-sidebar-section-card-Sessions"')
    expect(markup).toContain('data-testid="onyx-donor-sidebar-section-header-Agents"')
    expect(markup).toContain('data-testid="onyx-donor-sidebar-section-header-Sessions"')
