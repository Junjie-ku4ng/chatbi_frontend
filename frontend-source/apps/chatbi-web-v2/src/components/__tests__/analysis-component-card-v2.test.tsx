...
describe('AnalysisComponentCardV2', () => {
  it('renders xpert-style analysis actions and opens evidence and story flows', async () => {
    ...
    expect(getByTestId(container, 'analysis-component-card-v2-outer')).toBeTruthy()
    expect(getByTestId(container, 'answer-surface-view-table').className).toContain('onyx-donor-answer-surface-bookmark-tab')
    expect(getByTestId(container, 'answer-surface-view-table').getAttribute('data-state')).toBe('active')
    ...
    expect(getByTestId(container, 'answer-surface-shell-card').className).toContain('onyx-donor-answer-surface-embedded')
    ...
    expect(getByTestId(container, 'analysis-component-card-v2-surface-kind').textContent).toContain('图表 / 表格分析')
    ...
    expect(getByTestId(container, 'analysis-card-view-switch')).toBeTruthy()
    expect(getByTestId(container, 'analysis-card-view-switch').className).toContain('v2-analysis-card-bookmark-tabs')
    expect(getByTestId(container, 'analysis-component-card-v2-outer').querySelector('[data-testid="analysis-card-view-switch"]')).toBeTruthy()
    expect(getByTestId(container, 'answer-surface-toolbar-row').querySelector('[data-testid="analysis-card-view-switch"]')).toBeNull()
    ...
    expect(getByTestId(container, 'analysis-explorer-view-switch')).toBeTruthy()
