...
export function StorySaveDialog(props: StorySaveDialogProps) {
  ...
  return (
    <div className="chat-assistant-answer-surface-dialog" data-testid="answer-story-save-dialog" role="dialog" aria-modal="true">
      ...
      <form className="chat-assistant-component-panel" onSubmit={handleSubmit} style={{ display: 'grid', gap: 12 }}>
        ...
        {status ? (
          <p data-testid="answer-story-save-status" style={{ margin: 0 }}>
            {status}
          </p>
        ) : null}
      </form>
