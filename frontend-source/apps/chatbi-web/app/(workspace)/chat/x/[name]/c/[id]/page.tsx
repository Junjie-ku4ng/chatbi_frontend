...
type ChatNamespaceConversationPageProps = {
  params: Promise<{
    name: string
    id: string
  }>
...
export default async function ChatNamespaceConversationPage({ params, searchParams }: ChatNamespaceConversationPageProps) {
  const [{ name, id }, resolvedSearchParams] = await Promise.all([params, searchParams])
  void name
