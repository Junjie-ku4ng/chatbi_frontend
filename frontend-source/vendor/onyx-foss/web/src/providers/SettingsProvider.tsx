...
export function SettingsProvider({
  ...
  // In local frontend-only development, let the app render with fallback
  // settings instead of blocking on a missing backend.
  const shouldSuppressFatalError = IS_DEV && hasFatalError;

  if (hasFatalError && !shouldSuppressFatalError) {
